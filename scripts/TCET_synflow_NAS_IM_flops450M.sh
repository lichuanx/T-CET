...
save_dir=./save_dir/TCET_synflow_NAS_ImageNet_flops450M
mkdir -p ${save_dir}
...
CUDA_VISIBLE_DEVICES=1 python ts_train_image_classification.py --dataset imagenet --num_classes 1000 \
